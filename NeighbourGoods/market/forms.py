...
from wtforms import StringField, PasswordField, SubmitField, HiddenField, IntegerField, BooleanField
...
class RegisterProductForm(FlaskForm):
    ...
    price = IntegerField(label='Price (₹):', validators=[DataRequired(), NumberRange(min=1)])
